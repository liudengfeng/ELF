...
#undef _ELF_PYBIND_DECLARE_LOG_LEVEL
  ...
  m.def("drop", spdlog::drop)
      ...
      .def("daily_logger_mt", spdlog::daily_logger_mt<factory>)
      .def("rotating_logger_mt", spdlog::rotating_logger_mt<factory>)
      .def("stdout_logger_mt", spdlog::stdout_logger_mt<factory>)
      .def("stderr_logger_mt", spdlog::stderr_logger_mt<factory>)
      .def("stdout_color_mt", spdlog::stdout_color_mt<factory>)
      .def("stderr_color_mt", spdlog::stderr_color_mt<factory>);
  /* clang-format on */
}
